...
var getValidatedMonths = function (range, minDate, maxDate) {
    ...
    if (startDate && endDate) {
        ...
        return [newStart, date_fns_1.isSameMonth(newStart, newEnd) ? date_fns_1.addMonths(newStart, 1) : newEnd];
    }
    else {
...
var DateRangePickerImpl = function (props) {
    var today = new Date();
    var open = props.open, mobile = props.mobile, onChange = props.onChange, initialDateRange = props.initialDateRange, minDate = props.minDate, maxDate = props.maxDate, _a = props.definedRanges, definedRanges = _a === void 0 ? defaults_1.defaultRanges : _a;
    ...
    var onDayClick = function (day) {
        if (startDate && !endDate && !date_fns_1.isBefore(day, startDate)) {
    ...
    return open ? (React.createElement(Menu_1.default, { dateRange: dateRange, minDate: minDateValid, maxDate: maxDateValid, ranges: definedRanges, firstMonth: firstMonth, secondMonth: secondMonth, setFirstMonth: setFirstMonthValidated, setSecondMonth: setSecondMonthValidated, setDateRange: setDateRangeValidated, helpers: helpers, handlers: handlers, mobile: mobile })) : null;
};
